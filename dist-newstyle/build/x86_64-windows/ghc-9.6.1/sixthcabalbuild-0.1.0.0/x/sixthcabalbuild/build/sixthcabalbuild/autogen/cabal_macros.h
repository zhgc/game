...
/* package sixthcabalbuild-0.1.0.0 */
#ifndef VERSION_sixthcabalbuild
#define VERSION_sixthcabalbuild "0.1.0.0"
#endif /* VERSION_sixthcabalbuild */
#ifndef MIN_VERSION_sixthcabalbuild
#define MIN_VERSION_sixthcabalbuild(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sixthcabalbuild */
...
#define CURRENT_COMPONENT_ID "sixthcabalbuild-0.1.0.0-inplace-sixthcabalbuild"
